...
class DataExtraction:
    ...
    def extract_data(self, image):
        ...
        # Scale data points ONLY IF calibration is done
        if self.calibration.calibration_done:
            ...
            print("Scaled data points:", self.data_points)  # This line should remain
            # REMOVE THIS LINE:
            # print("Real distance:", self.calibration.real_distance)
        else:
